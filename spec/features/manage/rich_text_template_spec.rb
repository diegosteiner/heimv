...
describe 'RichTextTemplate', :devise do
  ...
  it 'can edit existing rich_text_template' do
    ...
    submit_form
    expect(page).to have_text I18n.t('flash.actions.update.notice', resource_name: RichTextTemplate.model_name.human)
    expect(page).to have_text changed_title
  end
end
