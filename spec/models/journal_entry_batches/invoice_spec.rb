...
RSpec.describe JournalEntryBatches::Invoice do
  ...
  describe '::build_with_invoice' do
    ...
    it 'builds batch with entries' do
      ...
      is_expected.to have_attributes(date: Date.new(2024, 12, 27), ref: invoice.ref, amount: 7200.0)
      expect(journal_entry_batch.entries).to contain_exactly(
        ...
        have_attributes(soll_account: '1050', haben_account: '6000', amount: 7200.0, cost_center: '9001',
                        vat_category_id: vat_category.id, vat_amount: 2400.0)
      )
    end
  end
