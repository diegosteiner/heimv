    ...
    def seed_development
      {
        tarifs: seeds[:homes].map do |home|
          [home, [
            Tarifs::Amount.create(home: home, label: 'Preis pro Übernachtung (unter 16 jährig)', unit: 'Übernachtungen (unter 16 jährig)', price_per_unit: 13.0, tarif_group: 'Lager/Kurs'),
            Tarifs::Amount.create(home: home, label: 'Preis pro Übernachtung (über 16 jährig)', unit: 'Übernachtungen (über 16 jährig)', price_per_unit: 13.0, tarif_group: 'Lager/Kurs'),
