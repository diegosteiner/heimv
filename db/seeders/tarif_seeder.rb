    ...
    seed :development do |seeds|
      {
        tarifs: seeds[:homes].map do |home|
          [home, [
            Tarifs::Amount.create(home: home, label: 'Lagertarif (unter 16 jährig)', unit: 'Übernachtungen', price_per_unit: 13.0, tarif_group: 'Lager/Kurs', invoice_type: :invoice),
            Tarifs::Amount.create(home: home, label: 'Lagertarif (über 16 jährig)', unit: 'Übernachtungen', price_per_unit: 13.0, tarif_group: 'Lager/Kurs', invoice_type: :invoice),
            ...
            Tarifs::Amount.create(home: home, label: 'Kurtaxe (6 bis 16 jährig)', unit: 'Übernachtungen', price_per_unit: 0.95, tarif_group: 'Kurtaxe', transient: true, invoice_type: :invoice),
            Tarifs::Amount.create(home: home, label: 'Kurtaxe (über 17 jährig)', unit: 'Übernachtungen', price_per_unit: 1.9, tarif_group: 'Kurtaxe', transient: true, invoice_type: :invoice),
