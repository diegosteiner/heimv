    ...
    def seed_development
      {
        tarifs: seeds[:homes].map do |home|
          ...
          Tarifs::Amount.create(home: home, label: 'Kurtaxe pro Übernachtung', unit: 'Übernachtungen (6 bis 16 jährig)', price_per_unit: 0.95, tarif_group: 'Kurtaxe')
          Tarifs::Amount.create(home: home, label: 'Kurtaxe pro Übernachtung', unit: 'Übernachtungen (über 17 jährig)', price_per_unit: 1.9, tarif_group: 'Kurtaxe')
