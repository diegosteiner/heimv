    ...
    def seed_development
      {
        tarifs: seeds[:homes].map do |home|
          [home, [
            ...
            Tarifs::Amount.create(home: home, label: 'Strom (Hochtarif)', unit: 'kWh', price_per_unit: 0.4, tarif_group: 'Nebenkosten', transient: true, invoice_type: :invoice),
            Tarifs::Amount.create(home: home, label: 'Strom (Niedertarif)', unit: 'kWh', price_per_unit: 0.35, tarif_group: 'Nebenkosten', transient: true, invoice_type: :invoice),
