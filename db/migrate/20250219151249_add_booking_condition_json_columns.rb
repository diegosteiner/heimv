...
class AddBookingConditionJsonColumns < ActiveRecord::Migration[8.0]
  def change
    add_column :tarifs, :selecting_conditions, :jsonb, null: true # rubocop:disable Rails/BulkChangeTable
    add_column :tarifs, :enabling_conditions, :jsonb, null: true
    add_column :booking_validations, :enabling_conditions, :jsonb, null: true # rubocop:disable Rails/BulkChangeTable
