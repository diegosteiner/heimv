...
class InitSchema < ActiveRecord::Migration
  def up
    ...
    create_table 'booking_agents' do |t|
      ...
      t.datetime 'updated_at', precision: nil, null: false
      t.bigint 'organisation_id', null: false
      t.integer 'request_deadline_minutes', default: 14_400
      t.index %w[code organisation_id], name: 'index_booking_agents_on_code_and_organisation_id', unique: true
    ...
    create_table 'booking_categories' do |t|
      ...
      t.index %w[key organisation_id], name: 'index_booking_categories_on_key_and_organisation_id', unique: true
    ...
    create_table 'booking_conditions' do |t|
      ...
      t.index %w[qualifiable_id qualifiable_type group], name: 'index_booking_conditions_on_qualifiable'
      t.index %w[qualifiable_id qualifiable_type],
              name: 'index_booking_conditions_on_qualifiable_id_and_qualifiable_type'
    end
    ...
    create_table 'booking_state_transitions' do |t|
      ...
      t.index %w[booking_id most_recent], name: 'index_booking_transitions_parent_most_recent', unique: true,
                                          where: 'most_recent'
      t.index %w[booking_id sort_key], name: 'index_booking_transitions_parent_sort', unique: true
    ...
    create_table 'deadlines' do |t|
      ...
      t.index %w[responsible_type responsible_id], name: 'index_deadlines_on_responsible'
    end
    ...
    create_table 'key_sequences' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w[key year organisation_id], name: 'index_key_sequences_on_key_and_year_and_organisation_id',
                                            unique: true
    ...
    create_table 'occupiables' do |t|
      ...
      t.index %w[ref organisation_id], name: 'index_occupiables_on_ref_and_organisation_id', unique: true
    end
    ...
    create_table 'organisation_users' do |t|
      ...
      t.datetime 'updated_at', null: false
      t.string 'token'
      t.index %w[organisation_id user_id], name: 'index_organisation_users_on_organisation_id_and_user_id',
                                           unique: true
    ...
    create_table 'rich_text_templates' do |t|
      ...
      t.index %w[key organisation_id], name: 'index_rich_text_templates_on_key_and_organisation_id', unique: true
    ...
    create_table 'tenants' do |t|
      ...
      t.integer 'sequence_number'
      t.string 'ref'
      t.index %w[email organisation_id], name: 'index_tenants_on_email_and_organisation_id', unique: true
    ...
    create_table 'usages' do |t|
      ...
      t.index %w[tarif_id booking_id], name: 'index_usages_on_tarif_id_and_booking_id', unique: true
    end
