...
module BookingStates
  class Upcoming < Base
    use_mail_template(:upcoming_notification, context: %i[booking], optional: true)
    use_mail_template(:operator_upcoming_notification, context: %i[booking], optional: true)
