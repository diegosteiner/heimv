document.addEventListener('turbolinks:load', function () {
    // var select = document.document.getElementsByClassName('form-group booking_customer_id');
    // var target = document.document.getElementsByClassName('.customer_attributes');
