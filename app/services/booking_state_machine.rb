class BookingStateMachine
  ...
  transition from: :pending,      to: [:awaiting_preconditions, :cancelled]
  transition from: :awaiting_preconditions,    to: [:reserved, :cancelled]
  transition from: :reserved, to: [:awaiting_postconditions, :cancelled]
